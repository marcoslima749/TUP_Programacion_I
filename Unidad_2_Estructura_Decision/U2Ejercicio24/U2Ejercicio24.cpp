...
y listar por pantalla a qué trimestre corresponde ese mes.
Tener en cuenta esta lista:
Mes 1, 2 y 3. Trimestre 1.
Mes 4, 5 y 6. Trimestre 2. 
Mes 7, 8 y 9. Trimestre 3.
Mes 10, 11 y 12. Trimestre 4.

Resolver este ejercicio utilizando la menor cantidad de salidas de IF posibles,
de forma tal que si en un hipotético caso, hubiera años de 200 meses
...
int main(){
    cout << "Ingrese el número de mes para saber a qué trimestre corresponde: " << endl;
	int mes, trimestre;
	cin >> mes;
    if(mes % 3 == 0) {
        trimestre = mes / 3;
	...
	cout << "El número pertenece al trimestre: " << trimestre;
    return 0;
}