/*
Hacer un programa para ingresar una lista de 10 números enteros,
...
int main(){
  int numero, maximo;
  int posicion;
  cout << "Ingrese 10 números enteros para conocer el máximo y su posición:" << endl;
  for(int i = 1; i <= 10; i++) {
    cin >> numero;
    if(i == 1) {
        maximo = numero;
  ...
  cout << "Máximo " << maximo << " Posición " << posicion;
  return 0;
}